...
class dolReceiptPrinter extends Printer
{
	...
	public function loadTemplate($templateid)
	{
		...
		if ($resql) {
			...
			$this->template ="{dol_align_center}\r\n{dol_double_height}{dol_bold}{dol_print_text}{dol_value_mysoc_name}{dol_default_height_width}{dol_bold_disabled}{dol_line_feed}{dol_print_text}{dol_value_mysoc_address}{dol_line_feed}{dol_print_text}{dol_value_mysoc_zip} {dol_value_mysoc_town}{dol_line_feed}{dol_print_text}Tel: {dol_value_mysoc_phone}{dol_line_feed}{dol_print_text}Mail: {dol_value_mysoc_mail}{dol_line_feed}{dol_print_text}{dol_value_mysoc_url}{dol_line_feed}{dol_line_feed}{dol_print_text}Date: {dol_value_currentdate}{dol_line_feed}{dol_print_text}Facture {dol_value_object_ref}{dol_line_feed}{dol_value_object_status}{dol_line_feed}{dol_align_left}{separator}{dol_print_lines_header}{separator_thin}{dol_line_feed}{dol_print_object_lines}{separator}\r\n{dol_line_feed}{dol_print_object_tax}\r\n{dol_line_feed}\r\n{dol_print_object_total_ht}\r\n{dol_print_object_total_vat}\r\n{dol_double_height}{dol_bold}{dol_print_object_total_ttc}{dol_default_height_width}{dol_bold_disabled}\r\n{dol_line_feed}{dol_print_payment}{dol_line_feed}{dol_line_feed}{dol_align_center}{dol_print_text}Tous nos prix sont en EUR{dol_line_feed}{dol_print_text}sauf indication contraire{dol_line_feed}{dol_print_text}SIRET: {dol_value_mysoc_idprof2} - NAF: {dol_value_mysoc_idprof3}{dol_line_feed}{dol_print_text}TVA Intracom: {dol_value_mysoc_tva_intra}{dol_line_feed}{dol_print_text}Merci de votre visite{dol_line_feed}{dol_cut_paper_full}";
		}
